...
- move the main todo I use in my dotfiles repo TO my obsidian vault, and then practise using that in the cli as well... and won't need to do so many commits!!!!!!!! much better system, will sync automatically ...


- FOR NOW bentobox is a pretty good solution for my needs, gets the job done... when I have more time, I can set up a more complex one, once I get it working on linux....otherwise I think it's just overkill... also find my old subscription to bentobox... as I've paid for it.. can always find the bank statement if I need....
- need to put in some time to setting up zoxide etc... will be a useful thing to do...
- set up hammerspoon well on my mac for ultimate configurability.. make it have the same keybindings as hyprland for linux... I can make a simlar set of scripts, and get some good LLM to rewrite them for me...


- I can also get tavily search API free as a student. get in touch with them and get hold of it... and then use it with claude etc for my searching... see if claude get back to me...

- Go on the leaderboards and see which llms are working best at the moment....
...
- GET USED TO USING THE TERMINAL PRETTY MUCH ALWAYS **INSIDE** NVIM... it's usually a much better way of doing things! I think basically most of the time just do stuff inside nvim, as that fulfils the majority of my needs...
...
- auto-start tmux + nvim in my ubuntu setup environment, when I start ubuntu... so that when I start a terminal session it automatically goes into them, with all my templates for the tmux windows that I want... so that I don't have to set it up every time...
  ...
  - write the code to start the kmonad mappings on my windows work machine... integrate it into my dotfiles workflow...
